...
This project is indexed by GitNexus as **noiserator** (589 symbols, 720 relationships, 5 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
