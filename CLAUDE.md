...
This project is indexed by GitNexus as **noiserator** (652 symbols, 826 relationships, 11 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
